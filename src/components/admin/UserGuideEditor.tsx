...
export const DEFAULT_GUIDE: UserGuideContent = {
  ...
  sections: [
    ...
    {
      key: 'data_security',
      heading: 'আপনার আর্থিক তথ্যের সুরক্ষা',
      items: [
        {
          title: 'শুধু আপনিই দেখতে পান আপনার ডেটা',
          desc: 'আপনার প্রতিটি লেনদেন, ওয়ালেট, ক্যাটাগরি, বাজেট ও ঋণের তথ্য ডেটাবেজ-লেভেলে আপনার অ্যাকাউন্টের সাথে আবদ্ধ। অন্য কোনো ইউজার — এমনকি আমরাও — আপনার অনুমতি ছাড়া এই তথ্য পড়তে পারি না।',
        },
        {
          title: 'Row Level Security (RLS) — ব্যাংক-গ্রেড সুরক্ষা',
          desc: 'আমরা PostgreSQL-এর Row Level Security ব্যবহার করি। অর্থাৎ ডেটাবেজ নিজেই প্রতিটি অনুরোধে যাচাই করে — "এই তথ্যটি কি সত্যিই এই ইউজারের?" না হলে ডেটা ফেরত দেয় না। কোডে কোনো বাগ থাকলেও এই সুরক্ষা স্তরটি ভেদ করা যায় না।',
        },
        {
          title: 'অ্যাডমিনও আপনার ব্যালেন্স দেখতে পান না',
          desc: 'আমাদের অ্যাডমিন প্যানেল শুধুমাত্র অ্যাকাউন্ট ব্যবস্থাপনা (নাম, ইমেইল, সাবস্ক্রিপশন স্ট্যাটাস) দেখতে পারে — কোনো ইউজারের লেনদেন, ব্যালেন্স বা আর্থিক তথ্য নয়। এটি ডেটাবেজ পলিসি দিয়ে কঠোরভাবে প্রয়োগ করা।',
        },
        {
          title: 'আসল ব্যাংক/বিকাশের সাথে কোনো সংযোগ নেই',
          desc: 'JomaKhoros একটি ম্যানুয়াল হিসাবরক্ষণ অ্যাপ — এটি কোনো ব্যাংক, বিকাশ, নগদ বা রকেট-এর API-এর সাথে যুক্ত নয়। তাই এখান থেকে কেউ আপনার আসল টাকা স্পর্শ করতে পারবে না।',
        },
        {
          title: 'আমরা পিন/পাসওয়ার্ড/OTP কখনো চাই না',
          desc: 'JomaKhoros কখনোই আপনার ব্যাংক পিন, মোবাইল ব্যাংকিং পাসওয়ার্ড, OTP বা কার্ড নম্বর চাইবে না। কেউ এসব চাইলে বুঝবেন সেটি প্রতারণা।',
        },
        {
          title: 'এনক্রিপ্টেড সংযোগ (HTTPS)',
          desc: 'আপনার ডিভাইস থেকে সার্ভার পর্যন্ত প্রতিটি ডেটা ট্রান্সফার TLS/HTTPS দিয়ে এনক্রিপ্টেড। মাঝপথে কেউ আপনার তথ্য পড়তে পারবে না।',
        },
        {
          title: 'নিরাপদ পাসওয়ার্ড সংরক্ষণ',
          desc: 'আপনার পাসওয়ার্ড আমরা hash করে রাখি — অর্থাৎ আমরা নিজেরাও আপনার পাসওয়ার্ড দেখতে পাই না। আপনি ভুলে গেলে নতুন পাসওয়ার্ড সেট করতে হবে।',
        },
        {
          title: 'অ্যাকাউন্ট ডিলিট = সব ডেটা ডিলিট',
          desc: 'যখনই আপনি অ্যাকাউন্ট মুছে ফেলবেন, আপনার সমস্ত আর্থিক তথ্য ডেটাবেজ থেকেও স্থায়ীভাবে মুছে যাবে। আমরা কোনো backup-এ আপনার ডেটা ধরে রাখি না।',
        },
        {
          title: 'স্বচ্ছতাই আমাদের অঙ্গীকার',
          desc: 'এই নিয়মগুলো শুধু কথায় নয় — কোডে ও ডেটাবেজ পলিসিতে লেখা। যেকোনো প্রশ্নে Terms পেইজ পড়ুন বা Feedback-এ আমাদের সরাসরি জিজ্ঞেস করুন।',
        },
      ],
    },
    {
